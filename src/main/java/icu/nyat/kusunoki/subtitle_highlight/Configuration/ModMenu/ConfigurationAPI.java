    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return (PreviousPage) -> {
            try {
                ...
                }).build()).addEntry(Constructor.entryBuilder().startLongField(Text.translatable("subtitle_highlight.configure.general.remove_delay"), ConfigManager.Options.MaximumDuration).setTooltip(Text.translatable("subtitle_highlight.configure.general.remove_delay.tooltip_1"), Text.translatable("subtitle_highlight.configure.general.remove_delay.tooltip_2"), Text.translatable("subtitle_highlight.configure.general.remove_delay.tooltip_3")).setDefaultValue(3000).setMin(0).setSaveConsumer((NewValue) -> {
                    ConfigManager.Options.MaximumDuration = NewValue;
